...
class EventSubClient(web.Application):
    ...
    def subscribe_channel_guest_session_update(
        self, broadcaster: Union[PartialUser, str, int], moderator: Union[PartialUser, str, int]
    ):
        return self._subscribe_with_broadcaster_moderator(
            models.SubscriptionTypes.channel_guest_session_end, broadcaster, moderator
        )

    def subscribe_channel_guest_slot_update(
        self, broadcaster: Union[PartialUser, str, int], moderator: Union[PartialUser, str, int]
    ):
        return self._subscribe_with_broadcaster_moderator(
            models.SubscriptionTypes.channel_guest_slot_update, broadcaster, moderator
        )

    def subscribe_channel_guest_settings_update(
        self, broadcaster: Union[PartialUser, str, int], moderator: Union[PartialUser, str, int]
    ):
        return self._subscribe_with_broadcaster_moderator(
            models.SubscriptionTypes.channel_guest_settings_update, broadcaster, moderator
        )
